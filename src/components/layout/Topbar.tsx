      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-10 pr-4 py-2 w-64 rounded-full border border-[#EAF1F9] bg-[#F1F8FE] focus:outline-none focus:ring-2 focus:ring-[#276FD1] focus:bg-white transition-all text-sm"
          />
        </div>
