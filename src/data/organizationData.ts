...
export const organizations = [
  ...
  },
  {
    ...
    consultancyServices: [
      {
        type: "Energy Platform Advisory",
        hours: 20,
        hourlyRate: 150,
        cost: 3000,
      },
      {
        type: "Data Integration Support",
        hours: 5,
        hourlyRate: 160,
        cost: 800,
      },
  ...
  },
  {
    ...
    consultancyServices: [
      {
        type: "Building Systems Integration",
        hours: 12,
        hourlyRate: 160,
        cost: 1920,
      },
...
export const dashboardSummary = {
  totalLicenseCost: organizations.reduce(
    (sum, org) => sum + org.licenseCost,
    0,
  ),
  totalConsultancyCost: organizations.reduce(
    (sum, org) => sum + org.consultancyCost,
    0,
  ),
  totalMonthlyCost: organizations.reduce(
    (sum, org) => sum + org.monthlyCost,
    0,
  ),
  totalChargeback: organizations.reduce(
    (sum, org) => sum + org.chargebackAmount,
    0,
  ),
  forecastNextMonth: organizations.reduce(
    (sum, org) => sum + org.forecast.nextMonth,
    0,
  ),
  forecastThreeMonths: organizations.reduce(
    (sum, org) => sum + org.forecast.threeMonths,
    0,
  ),
};
