    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center text-sm ml-2">
          ...
          <span className="mx-1" style={{ color: 'var(--color-ui-blue-lighter)' }}>/</span>
      ...
      <Button 
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.backgroundColor = 'var(--color-ui-blue-lighter)';
        ...
        <div className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-neutral-900 mb-2">{user.name}</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-2 text-neutral-700">
                  <Mail className="w-4 h-4" style={{ color: 'var(--color-ui-blue-primary)' }} />
                  <span className="text-sm">{user.email}</span>
                </div>
                <div className="flex items-center gap-2 text-neutral-700">
                  <Building2 className="w-4 h-4" style={{ color: 'var(--color-ui-blue-primary)' }} />
                  <span className="text-sm">{user.department}</span>
                </div>
                <div className="flex items-center gap-2 text-neutral-700">
                  <Calendar className="w-4 h-4" style={{ color: 'var(--color-ui-blue-primary)' }} />
              ...
              <div className="mt-3">
                <span 
                  ...
                  style={{
                    backgroundColor: user.status === 'active' ? 'var(--color-ui-green-light)' : 'var(--color-neutral-100)',
                    color: user.status === 'active' ? 'var(--color-ui-green)' : 'var(--color-neutral-600)'
                  }}
                >
            ...
            <div className="flex gap-2">
              ...
              <Button 
                variant="primary" 
                size="sm" 
                style={{ backgroundColor: 'var(--color-ui-blue-primary)', color: 'white' }}
              >
                Manage Licenses
              </Button>
            </div>
            ...
            <div className="space-y-3">
              {user.licenses.map((license, index) => (
                <div 
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--color-ui-blue-lighter)'}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-500">Active since Jan 2024</p>
                    </div>
                  </div>
                  <Button 
                    variant="ghost" 
            ...
            <div className="space-y-4">
              ...
              >
                <div>
                  ...
                  <h2 className="text-3xl font-bold text-neutral-900">{user.licenses.length}</h2>
                </div>
                <div 
                  className="w-12 h-12 text-white rounded-full flex items-center justify-center"
                  style={{ backgroundColor: 'var(--color-ui-blue-primary)' }}
                >
                  <span className="text-xl font-bold">{user.licenses.length}</span>
                </div>
              </div>
              <div 
              ...
              >
                ...
                <p className="text-xs text-neutral-500 mt-1">Average per license: €85.00</p>
              </div>
              <div 
              ...
              >
                ...
                <h4 className="text-lg font-bold text-neutral-900">Full Access</h4>
                <p className="text-xs text-neutral-500 mt-1">All licenses active and accessible</p>
              </div>
            </div>
          </div>
        </Card>
