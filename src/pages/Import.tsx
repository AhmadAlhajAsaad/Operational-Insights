      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 text-lg">
            Import your organizations or users data from Excel or CSV files
          </p>
        </div>
        ...
        <div className="mb-8 bg-white rounded-xl shadow-lg p-6 border border-slate-200">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-ui-blue-primary text-white rounded-full flex items-center justify-center text-xs font-bold">
                1
              </div>
              <div>
                <p className="font-medium text-slate-900">Choose Data Type</p>
                <p className="text-slate-600">
                  Select organizations or users above
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Drag & drop or click to select CSV/Excel
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
          ...
          >
            <div className="flex items-center gap-3 justify-center">
              ...
              <div className="text-left">
                ...
                <div
                  className={`text-sm ${type === "organizations" ? "text-blue-100" : "text-slate-500"}`}
                >
                  Import company data
                </div>
              </div>
          ...
          >
            <div className="flex items-center gap-3 justify-center">
              ...
              <div className="text-left">
                ...
                <div
                  className={`text-sm ${type === "users" ? "text-blue-100" : "text-slate-500"}`}
                >
